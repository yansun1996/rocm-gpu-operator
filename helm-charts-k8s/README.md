...
| deviceConfig.spec.devicePlugin.devicePluginHostNetwork | bool | `false` | spcify whether to use host network for device plugin daemonset |
...
| deviceConfig.spec.metricsExporter.hostNetwork | bool | `false` | spcify whether to use host network for metrics exporter daemonset |
