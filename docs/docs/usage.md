...
1. Create a YAML file named `amd-smi.yaml`:
...
3. Check the logs and verify the output `amd-smi` reflects the expected ROCm version and GPU presence:
...
1. Create a YAML file named `rocminfo.yaml`:
...
3. Check the logs and verify the output:
