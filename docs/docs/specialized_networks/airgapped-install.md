- [AMD GPU Operator Air-gapped Installation Guide](#amd-gpu-operator-air-gapped-installation-guide)
  - [Prerequisites](#prerequisites)
    - [Required Images](#required-images)
    - [Required RPM/DEB Packages](#required-rpmdeb-packages)
      - [RHEL/CentOS:](#rhelcentos)
      - [Ubuntu:](#ubuntu)
  - [Installation Steps](#installation-steps)
    - [1. Mirror Required Images](#1-mirror-required-images)
    - [2. Configure Internal Package Repository](#2-configure-internal-package-repository)
    - [3. Install Cert-Manager](#3-install-cert-manager)
    - [4. Install AMD GPU Operator](#4-install-amd-gpu-operator)
    - [5. Configure DeviceConfig](#5-configure-deviceconfig)
...
# AMD GPU Operator Air-gapped Installation Guide

!!! warning "TESTING NEEDED"
    These steps have not been yet been tested. These steps need to be validated.
...
1. Create custom values file for cert-manager:
...
2. Install cert-manager using internal images:
