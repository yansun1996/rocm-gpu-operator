- [Uninstallation](#uninstallation)
    - [Uninstall Custom Resource](#uninstall-custom-resource)
    - [Uninstall Helm Charts](#uninstall-helm-charts)
    - [Uninstall OLM Bundle](#uninstall-olm-bundle)
    - [Uninstall Custom Resource Definition](#uninstall-custom-resource-definition)
...
!!! warning "Think more before removing all CRDs"
    If the CRDs of cert-manager, NFD and KMM are being used by other operators other than AMD GPU operator, deleting those CRDs may affect other operators, in that scenario please evaluate the risk of removing those dependency CRDs. 